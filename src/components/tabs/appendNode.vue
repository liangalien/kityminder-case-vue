<template>
    <div class="km-btn-group">
        ...
        <el-row>
            <el-link :disabled="isDisabled('AppendSameNode')" @click="minder.execCommand('AppendSameNode')" :underline="false" type="primary"><i class="el-icon-refresh"></i> 插入同级</el-link>
        </el-row>
    </div>
</template>
